...
function SearchPopup(props) {
  const { closer, contents, getflashcard } = props;
  ...
  function orderEdit(id, state) {
    axios
      .post(
        `https://drmollaii.ir/v1/public/admin/flashcard/order/edit`,
        {
          id,
          state,
        },
  ...
  return (
    <div className="searchpopup" onClick={e => e.target === e.currentTarget && closer()}>
      {edit_id && (
